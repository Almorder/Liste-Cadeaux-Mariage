    ...
    <div class="modal-shell" role="dialog" aria-modal="true">
      <form class="modal" id="participationForm">
        ...
        <div class="form-grid">
          ...
          <label class="consent-line coordination-consent field full">
            <input type="checkbox" name="whatsappConsent" required>
            <span>J’accepte d’être contacté(e) par Myriam ou Nolan sur WhatsApp au sujet de ce cadeau et de recevoir, si nécessaire, un lien d’invitation vers un groupe avec les autres participants.</span>
          </label>
          <div class="visually-hidden" aria-hidden="true"><label>Site web<input name="website" tabindex="-1" autocomplete="off"></label></div>
        </div>
        <div class="form-note">Votre numéro reste dans l’espace privé. Il n’est transmis à personne : vous choisissez vous-même de rejoindre le groupe WhatsApp grâce au lien d’invitation.</div>
    ...
    <div class="modal-shell" role="dialog" aria-modal="true">
      <form class="modal" id="contactForm">
        ...
        <div class="form-grid">
          ...
          <label class="consent-line coordination-consent field full">
            <input type="checkbox" name="whatsappConsent" required>
            <span>J’accepte d’être contacté(e) sur WhatsApp au sujet de ce cadeau et de recevoir un lien d’invitation vers le groupe des participants.</span>
          </label>
          <div class="visually-hidden" aria-hidden="true"><label>Site web<input name="website" tabindex="-1" autocomplete="off"></label></div>
        </div>
        <div class="form-note">Votre numéro reste privé. Vous rejoignez le groupe uniquement si vous ouvrez volontairement le lien reçu.</div>
        <input type="hidden" name="startedAt" value="${Date.now()}">
